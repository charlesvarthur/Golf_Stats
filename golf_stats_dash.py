...
'This \"box and whisker\" diagram shows the low, high and median scores. Each box conrains the bulk of results and encompases data between the '
...
course_var = st.selectbox('Select a course to provide data for, in figures 2, 3 and 4:',course_names[:])
